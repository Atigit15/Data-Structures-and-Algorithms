...
/*
		...
		Credits : Harisam Sharma (youtube.com/watch?v=dexE7JwxrMU)
		Point Update Range Query (sum,min,max,and,or,xor,gcd)
		Any associative operation
		This templates also supports lazy propogation
